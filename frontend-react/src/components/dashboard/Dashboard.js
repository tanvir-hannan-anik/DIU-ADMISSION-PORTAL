...
const QuickAccessCards = () => {
  ...
  const cards = [
    ...
    },
    {
      ...
      description: 'Discover world-class clubs, transport routes, and hostel accommodations available on campus.',
      icon: 'apartment',
    ...
    },
    {
      ...
      description: 'Meet our experienced educators, researchers, and industry professionals across all departments.',
      icon: 'school',
...
const STATIC_DEPARTMENTS = [
  { name: 'Computing and Information System', short: 'CIS', visits: 5341, trend: '+27%', color: 'bg-cyan-500', trendColor: 'text-cyan-600' },
